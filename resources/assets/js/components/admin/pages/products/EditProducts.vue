                ...
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-header">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <select name="select" id="select" class="form-control" v-model='editProductnew.subcates.id'>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="text-input" placeholder="Text" class="form-control" v-model='editProductnew.name'>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="text-input" name="text-input" placeholder="Text" class="form-control" v-model='editProductnew.price'>
                                <small class="form-text text-muted">This is a help text</small>
                            </div>
                          </div>
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="text-input" name="text-input" placeholder="Text" class="form-control" v-model='editProductnew.importprices'>
                                <small class="form-text text-muted">This is a help text</small>
                            </div>
                          </div>
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="text-input" name="text-input" placeholder="Text" class="form-control" v-model='editProductnew.discount'>
                                <small class="form-text text-muted">This is a help text</small>
                            </div>
                          </div>
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="text-input" placeholder="Text" class="form-control" v-model='editProductnew.thongtinkhuyenmai'>
                                <small class="form-text text-muted">This is a help text</small>
                            </div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><textarea name="textarea-input" id="textarea-input" rows="9" placeholder="Content..." class="form-control" v-model='editProductnew.thongsokithuat'></textarea></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col col-md-9">
                              <div class="form-check-inline form-check">
                                <label for="inline-radio1" class="form-check-label ">
                                  <input type="radio" id="inline-radio1" name="inline-radios" value="1" class="form-check-input" v-model='editProductnew.noibat'>Có
                                </label>
                                <label for="inline-radio2" class="form-check-label ">
                                  <input type="radio" id="inline-radio2" name="inline-radios" value="0" class="form-check-input" v-model='editProductnew.noibat'>Không
                                </label>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="file" id='file' class="form-control-file" v-on:change='uploadImg(editProductnew)' 
                                ref='file'>
                                 <img :src="editProductnew.image">
                                 <input type="hidden" name="" v-model='editProductnew.image'>
                            </div>
                      ...
                      <div class="card-footer">
                        <button class="btn btn-primary btn-sm" @click='updateProduct(editProductnew)'>
    ...
    components:{
      ...
      Nav
        ...
        methods:{
            chooseProducts(){
             ...
             uploadImg(item){
                let file
                    ...
                    this.product.image = "/img/"+ file.name;      
            ...
            getProducts(){
                axios.get('/admin/products/editproducts/'+this.$route.params.id).then(response=>{
                    this.editProductnew = response.data.editProductnew
                    console.log(this.editProductnew)
                })
            },
            editProduct(item) { // ->ok
                item.isEdit = true
            ...
            updateProduct(item) {
                axios.post('/admin/products/postupdateproducts/' + item.id, {
                      ...
                      image:item.image})
                .then(response => {
                     Vue.swal('success','Sửa sản phẩm thành công !!','success')
